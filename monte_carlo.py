...
if __name__ == "__main__":
    temps, electricity, food_waste = MonteCarlo(8640, ThermostatSimple(5)).run_simulation()
    #print(f"Temps: {temps}")
    #print(f"Electricity: {electricity}")
    #print(f"Food Waste: {food_waste}")
    print(f"Sum of all costs in Septemper 2022: {sum(electricity)+sum(food_waste)},-")
